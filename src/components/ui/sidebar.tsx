...
>(({ className, ...props }, ref) => {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn(
        "relative flex w-full min-w-0 flex-col p-2 group-data-[collapsible=icon]:overflow-visible",
        className
      )}
      {...props}
    />
...
>(({ className, ...props }, ref) => (
  <ul
    ...
    data-sidebar="menu"
    className={cn(
      "flex w-full min-w-0 flex-col gap-1 group-data-[collapsible=icon]:overflow-visible",
      className
    )}
    {...props}
  />
